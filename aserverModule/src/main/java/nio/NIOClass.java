...
//        System.out.println("1.txt exists " + Files.exists(path));
        // создание
        Path path2 = Paths.get("client", "dir1", "dir2", "1.txt");
        Path pathDir2 = Paths.get("client", "dir1", "dir2");
//        if(!Files.exists(path2)) {
//            Files.createFile(path2);
//        }
        // перемещение
//        Path path3 = Files.move(Paths.get("client" + File.separator + "2.txt"), path2, StandardCopyOption.ATOMIC_MOVE);

        // копирование
//        Path path4 = Files.copy(Paths.get("client" + File.separator + "3.txt"), path2, StandardCopyOption.REPLACE_EXISTING);
